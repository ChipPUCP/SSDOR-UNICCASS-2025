...
C {/shared/designs/SSDOR_1V_v1/components/trans_gate/trans_gate.sym} 360 -200 0 0 {name=x3}
C {/shared/designs/SSDOR_1V_v1/components/trans_gate_low/trans_gate_low.sym} 360 -400 0 0 {name=x2}
