...
C {sg13g2_pr/ptap1.sym} 1050 -380 2 0 {name=R4
model=ptap1
spiceprefix=X
w=12.0e-6
l=1.0e-6
}
C {lab_pin.sym} 230 -360 2 1 {name=p15 sig_type=std_logic lab=sub!}
C {lab_pin.sym} 770 -360 2 0 {name=p16 sig_type=std_logic lab=sub!}
C {lab_pin.sym} 340 -220 2 1 {name=p17 sig_type=std_logic lab=sub!}
C {lab_pin.sym} 490 -220 2 1 {name=p18 sig_type=std_logic lab=sub!}
C {lab_pin.sym} 910 -220 2 0 {name=p19 sig_type=std_logic lab=sub!}
C {lab_pin.sym} 1050 -430 2 1 {name=p20 sig_type=std_logic lab=sub!}
C {lab_pin.sym} 1050 -330 2 1 {name=p21 sig_type=std_logic lab=VSS}
