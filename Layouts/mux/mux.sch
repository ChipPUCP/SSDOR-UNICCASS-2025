...
N 760 -230 760 -210 {lab=well}
N 760 -150 760 -130 {lab=VDD}
N 440 -560 440 -520 {lab=VSS}
N 440 -700 440 -660 {lab=well}
N 440 -360 440 -320 {lab=well}
N 440 -220 440 -180 {lab=VSS}
N 300 -440 300 -420 {lab=#net1}
N 240 -490 260 -490 {lab=S}
N 240 -440 240 -390 {lab=S}
N 240 -390 260 -390 {lab=S}
N 240 -490 240 -440 {lab=S}
N 300 -440 440 -440 {lab=#net1}
N 300 -460 300 -440 {lab=#net1}
N 200 -440 240 -440 {lab=S}
N 300 -800 300 -520 {lab=VDD}
N 300 -360 300 -80 {lab=VSS}
N 300 -490 330 -490 {lab=well}
N 300 -390 330 -390 {lab=VSS}
...
C {sg13g2_pr/ntap1.sym} 760 -180 2 0 {name=R1
model=ntap1
spiceprefix=X
w=3.0e-6
l=1.0e-6
}
C {lab_pin.sym} 760 -130 2 1 {name=p8 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 440 -660 1 1 {name=p10 sig_type=std_logic lab=well}
C {lab_pin.sym} 440 -560 3 1 {name=p11 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 440 -220 3 1 {name=p13 sig_type=std_logic lab=VSS}
C {sg13g2_pr/sg13_lv_nmos.sym} 280 -390 0 0 {name=M5
l=0.13u
w=0.5u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_pmos.sym} 280 -490 0 0 {name=M6
l=0.13u
w=1u
ng=1
m=1
...
C {lab_pin.sym} 330 -490 2 0 {name=p14 sig_type=std_logic lab=well}
C {lab_pin.sym} 330 -390 2 0 {name=p15 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 440 -320 1 1 {name=p7 sig_type=std_logic lab=well}
C {lab_pin.sym} 760 -230 2 1 {name=p9 sig_type=std_logic lab=well}
