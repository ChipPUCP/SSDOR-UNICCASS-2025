...
C {/shared/designs/SSDOR_1.2V_v2/components/trans_gate/tg_buff.sym} 220 -480 0 0 {name=x3}
C {/shared/designs/SSDOR_1.2V_v2/components/trans_gate/tg_inverter.sym} 420 -480 0 0 {name=x1}
