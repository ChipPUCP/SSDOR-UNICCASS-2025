...
N 460 -30 460 10 {lab=#net4}
N 420 -30 460 -30 {lab=#net4}
N 800 -90 800 10 {lab=#net5}
N 780 10 800 10 {lab=#net5}
N 660 -30 680 -30 {lab=#net5}
N 660 -90 660 -30 {lab=#net5}
N 660 -90 800 -90 {lab=#net5}
N 780 -30 830 -30 {lab=vout}
N 600 -30 640 -30 {lab=#net6}
N 640 -30 640 10 {lab=#net6}
N 110 -10 140 -10 {lab=#net7}
N 260 -10 290 -10 {lab=#net2}
N 640 10 680 10 {lab=#net6}
N 550 140 730 140 {lab=vss}
N 550 -160 730 -160 {lab=vdd}
N 50 -160 50 -50 {lab=vdd}
N -80 -160 50 -160 {lab=vdd}
N 460 10 500 10 {lab=#net4}
...
C {/shared/designs/SSDOR_1.2V_v2/components/cgenerator/inv.sym} 140 40 0 0 {name=xi1}
C {/shared/designs/SSDOR_1.2V_v2/components/cgenerator/dff2.sym} 370 -10 0 0 {name=xdff1}
C {/shared/designs/SSDOR_1.2V_v2/components/cgenerator/dff2.sym} 550 -10 0 0 {name=xdff2}
C {/shared/designs/SSDOR_1.2V_v2/components/cgenerator/dff2.sym} 730 -10 0 0 {name=xdff3}
C {/shared/designs/SSDOR_1.2V_v2/components/cgenerator/ota_cmp2.sym} 40 0 0 0 {name=xo1}
