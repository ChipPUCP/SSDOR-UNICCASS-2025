...
C {/shared/designs/SSDOR_1.2V_v2/components/trans_gate_low/tg_low_noninverbuff.sym} 220 -100 0 0 {name=x3}
C {/shared/designs/SSDOR_1.2V_v2/components/trans_gate_low/tg_low_inverter.sym} 420 -100 0 0 {name=x1}
