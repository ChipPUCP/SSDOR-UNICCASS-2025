...
N 390 -280 390 -250 {lab=Vin+}
N 390 -220 390 -160 {lab=VSS}
N 390 -280 430 -280 {lab=Vin+}
N 430 -280 430 -220 {lab=Vin+}
N 430 -280 620 -280 {lab=Vin+}
N 620 -280 620 -220 {lab=Vin+}
N 580 -220 620 -220 {lab=Vin+}
N 0 -330 0 -300 {lab=#net4}
N 0 -300 60 -300 {lab=#net4}
N -50 -280 60 -280 {lab=I_bias}
N 40 -260 60 -260 {lab=SEL}
N 40 -260 40 -170 {lab=SEL}
N 0 -440 0 -390 {lab=VDD}
N 0 -440 120 -440 {lab=VDD}
N 120 -440 120 -340 {lab=VDD}
N -50 -170 40 -170 {lab=SEL}
N -60 -440 0 -440 {lab=VDD}
N 120 -220 120 -160 {lab=VSS}
N 280 -160 390 -160 {lab=VSS}
N 390 -560 390 -280 {lab=Vin+}
N 390 -560 540 -560 {lab=Vin+}
N 390 -160 540 -160 {lab=VSS}
N 180 -280 390 -280 {lab=Vin+}
N 120 -160 280 -160 {lab=VSS}
...
C {ipin.sym} -50 -280 0 0 {name=p1 lab=I_bias}
...
C {/shared/designs/SSDOR_1.2V_v2/components/mux2_b/mux2_b.sym} 120 -280 0 0 {name=x12}
C {ipin.sym} -60 -440 0 0 {name=p6 lab=VDD}
C {ipin.sym} -50 -170 0 0 {name=p7 lab=SEL}
